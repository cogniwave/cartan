...
class ScaffoldMessengerService {
  static final ScaffoldMessengerService _instance =
  ...
  ThemeData get theme {
    if (_currentTheme == null) {
      throw Exception(
        'Theme not initialized in ScaffoldMessengerService. Call initialize() first.',
      );
    }
  ...
  AppLocalizations get localizations {
    if (_currentLocalizations == null) {
      throw Exception(
        'Localizations not initialized in ScaffoldMessengerService. Call initialize() first.',
      );
    }
