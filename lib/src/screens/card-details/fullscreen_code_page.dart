...
class FullScreenCodePage extends StatefulWidget {
  ...
  const FullScreenCodePage({super.key, required this.cardNumber, required this.showQrCode});
...
class _FullScreenCodePageState extends State<FullScreenCodePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double containerWidth = widget.showQrCode ? screenWidth * 0.85 : screenWidth * 0.6;

    final double containerHeight = widget.showQrCode ? screenWidth * 0.85 : screenHeight * 0.8;
